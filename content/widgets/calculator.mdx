...
-   `custom`: the widget renders with custom colors. These colors can be supplied with
    4 other data-attributes: `data-color`, `data-background-color`, `data-button-color`, and
    `data-button-background-color`.  
    ⚠ All 4 color attributes must be supplied in order for the custom theme to work.
...
This will change the text color of the body copy to the given value. The value
...
This will change the background color of the entire widget to the given value. The value
can be any valid CSS color.
...
This will change the text color of the submit button to the given value. The value
can be any valid CSS color.
...
This will change the background color of the submit button to the given value. The value
can be any valid CSS color.
...
<p
    ...
    data-user="beequip"
    data-slug-hash="LYVRrro"
    data-pen-title="Calculator widget with a bunch of options"
>
    <span>
        See the Pen{' '}
        <a href="https://codepen.io/beequip/pen/LYVRrro">
            Calculator widget with a bunch of options
        </a>{' '}
        by Beequip (<a href="https://codepen.io/beequip">@beequip</a>) on{' '}
