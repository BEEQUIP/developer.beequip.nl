...
```html
<a href="https://lease.beequip.nl" class="beequip-button" data-token="Xhpx7QT6xRF9ZHyABrxmm12Q">Lease equipment bij Beequip</a>
```
...
```html
<a data-button-text="Some custom button text">
```
