...
We use a unique token as an identifier for your organisation. This way, we can:
 
- Use your interest rates in the lease calculations that the widget performs.
