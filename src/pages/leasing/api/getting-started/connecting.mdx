...
While developing, you can connect to https://staging.api.beequip.com/graphql. This prevents test data from polluting our
production systems.
...
When you’re ready to release your code, change the endpoint URL to https://api.beequip.com/graphql. You’ll also need a
