...
import { Notification, Text } from '@beequip/hexagon'
...
<a
    ...
    >Lease equipment bij Beequip</a
>
<script async src="https://widgets.beequip.com/embed-calculator.js"></script>
```
...
An integer representing the sub subcategory the equipment belongs to. Lookup the appropriate ID in
the [category table](#available-categories).
...
A string that will set the text color of the body copy to the given value. The value
...
A string that will set the background color of the entire widget to the given value. The value
can be any valid CSS color.
...
A string that will set the text color of the primary button to the given value. The value
can be any valid CSS color.
...
A string that will set the background color of the primary button to the given value. The value
can be any valid CSS color.
...
A string that will set the text color of the secondary button to the given value. The value
can be any valid CSS color.
...
A string that will set the background color of the secondary button to the given value. The value
can be any valid CSS color.
...
A boolean indicating whether the logo of Beequip will be shown in the widget.
Defaults to `true`.
