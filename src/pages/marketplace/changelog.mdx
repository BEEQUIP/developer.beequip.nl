...
- Field `model` was added to type `AddObjectInput`.
  This was added to provide more granular details when adding an object. For example, when adding a “Citroën Berlingo 2.3 HDI”, you previously had to set the field `type` to “Berlingo 2.0 HDI”. With the new `model` field, you can set the `model` to “Berlingo” and `type` to “2.0 HDI”.
