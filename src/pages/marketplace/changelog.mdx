...
- Field `canObjectBePlaced` (deprecated) will be removed from type `Query`.
- Field `propupsion` (deprecated) will be removed from type `Object`.
- Field `ChamberOfCommerceNumberNotResolvedError` (deprecated) will be removed from type `AddCompanyResult`.
